...
router.post('/books/:bookId', authenticateToken, async (req: AuthenticatedRequest, res: Response) => {
  try {
...
router.post('/lessons/:lessonId', authenticateToken, async (req: AuthenticatedRequest, res: Response) => {
  try {
