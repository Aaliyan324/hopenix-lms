...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-100 via-orange-50 to-white flex flex-col justify-center items-center p-4 sm:p-6 relative overflow-hidden font-['Poppins',sans-serif]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="pt-2">
            <Button
              ...
              variant="primary"
              size="lg"
              className="w-full bg-orange-600 hover:bg-orange-700 text-white font-medium py-3.5 rounded-2xl shadow-lg shadow-orange-600/20 transition-all duration-200 active:scale-[0.99] font-['Poppins',sans-serif]"
              loading={loading}
