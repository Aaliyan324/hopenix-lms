  ...
  return (
    <div className="space-y-12 max-w-7xl mx-auto pb-24 px-4 sm:px-6 lg:px-8">
      ...
      <Link
        ...
        className="inline-flex items-center gap-2 text-sm font-semibold text-stone-600 hover:text-orange-700 bg-white border border-stone-200 hover:border-orange-300 hover:bg-orange-50 px-4 py-2 rounded-xl transition-all shadow-sm"
      >
      ...
      <div className="bg-white border border-stone-200/80 rounded-3xl p-6 sm:p-10 shadow-editorial">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-10 items-start">
          {/* Authentic Book Cover Presentation — complete, uncropped */}
          <div className="md:col-span-4 flex justify-center">
            <div className="group relative flex h-80 w-56 items-center justify-center overflow-hidden rounded-2xl border border-stone-200/80 bg-gradient-to-br from-stone-100 via-orange-50/50 to-stone-100 p-4 shadow-book sm:h-96 sm:w-64">
              <img
                ...
                className="h-full w-full object-contain drop-shadow-[0_16px_28px_rgba(28,25,23,0.22)] transition-transform duration-500 ease-out group-hover:scale-[1.03]"
              />
              {/* Corner badge */}
              <div className="absolute top-3 right-3">
                <span className="inline-flex items-center gap-1 rounded-full bg-orange-500 px-2.5 py-1 text-[10px] font-bold text-white shadow-lg shadow-orange-500/25">
          ...
          <div className="md:col-span-8 flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div className="flex items-center gap-2">
                  ...
                  {book.readingLevel && (
                    <Badge variant="slate" size="sm" className="bg-stone-50 text-stone-700 border-stone-200">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-stone-50 border border-stone-200 text-stone-700 hover:text-orange-700 hover:bg-orange-50 hover:border-orange-300 text-xs font-semibold transition-all shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2"
            ...
            {/* Specifications Grid */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 py-4 border-y border-stone-200 text-sm">
              <div className="bg-stone-50 p-3.5 rounded-xl border border-stone-200 hover:border-orange-300 transition-colors">
                <span className="text-stone-500 block font-medium text-xs">Chapters</span>
              ...
              <div className="bg-stone-50 p-3.5 rounded-xl border border-stone-200 hover:border-orange-300 transition-colors">
                <span className="text-stone-500 block font-medium text-xs">Language</span>
                <span className="font-bold text-stone-900 flex items-center gap-1.5 mt-0.5">
              ...
              <div className="bg-stone-50 p-3.5 rounded-xl border border-stone-200 hover:border-orange-300 transition-colors">
                <span className="text-stone-500 block font-medium text-xs">Reading Level</span>
                <span className="font-bold text-stone-900 flex items-center gap-1.5 mt-0.5">
              ...
              <div className="bg-stone-50 p-3.5 rounded-xl border border-stone-200 hover:border-orange-300 transition-colors">
                <span className="text-stone-500 block font-medium text-xs">Published</span>
                <span className="font-bold text-stone-900 flex items-center gap-1.5 mt-0.5">
            ...
            <div className="pt-2">
              {firstLesson && (
                <Link
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-orange-600 hover:bg-orange-700 text-white text-sm font-semibold rounded-2xl transition-all shadow-lg shadow-orange-600/25 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2 active:scale-[0.99]"
                >
      ...
      <div className="space-y-5">
        <div className="flex items-center gap-3 border-b border-stone-200 pb-3">
          ...
          <div>
            ...
            <p className="text-xs text-stone-500 mt-0.5">Explore the chapters included in this publication</p>
          </div>
          ...
          {book.lessons?.map((lesson, idx) => {
            ...
            return (
              <Link
                ...
                className="flex flex-col sm:flex-row sm:items-center justify-between p-4 sm:p-5 rounded-2xl border border-stone-200/80 bg-white hover:border-orange-300 hover:shadow-editorial transition-all group"
              >
                <div className="flex items-center gap-4 mb-2 sm:mb-0">
                  ...
                  <div className="space-y-0.5">
                    <h3 className="font-serif font-bold text-base text-stone-900 group-hover:text-orange-700 transition-colors">
                      {lesson.title}
                    </h3>
                    {lesson.description && (
                      <p className="text-xs text-stone-500 line-clamp-1">{lesson.description}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between sm:justify-end gap-3 shrink-0 pt-2 sm:pt-0 border-t sm:border-t-0 border-stone-100">
                  {lesson.media && lesson.media.length > 0 && (
                    <span className="text-xs font-medium text-stone-500 bg-stone-100 px-2.5 py-1 rounded-lg border border-stone-200">
