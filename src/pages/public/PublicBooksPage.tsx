...
export const PublicBooksPage: React.FC = () => {
  ...
  return (
    <div className="space-y-10 max-w-7xl mx-auto pb-20 px-4 sm:px-6 lg:px-8">
            ...
            <form onSubmit={handleSearchSubmit} className="flex flex-col sm:flex-row gap-3 pt-4 w-full">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full bg-white/10 backdrop-blur-sm border border-white/20 focus:border-orange-400 focus:ring-2 focus:ring-orange-400/30 rounded-xl pl-10 pr-4 py-3 text-sm text-white placeholder-slate-400 outline-none transition-all"
                />
              </div>
              <button 
                type="submit" 
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-4 rounded-2xl bg-white border border-slate-200/80 shadow-editorial">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl font-semibold text-xs transition-all whitespace-nowrap ${
              selectedCategory === ''
                ...
                : 'bg-slate-100 text-slate-700 hover:bg-orange-50 hover:text-orange-700 hover:border-orange-300 border border-slate-200'
            }`}
          >
        ...
        <div className="flex items-center gap-2 shrink-0 self-end md:self-auto bg-slate-50 px-3 py-1.5 rounded-xl border border-slate-200">
          ...
          >
            <option value="" className="bg-white text-slate-900">All Levels</option>
            ...
            <option value="Advanced" className="bg-white text-slate-900">Advanced</option>
          </select>
        </div>
      </div>
      ...
      {featuredBooks.length > 0 && !search && !selectedCategory && (
        <div className="space-y-5">
          <div className="flex items-center gap-3 border-b border-slate-200 pb-3">
            ...
            <h2 className="font-serif text-2xl font-bold text-slate-900">Featured Publications</h2>
          </div>
      ...
      <div className="space-y-5">
        ...
        {loading ? (
          ...
          <div className="bg-white border border-slate-200/80 rounded-3xl p-12 text-center space-y-4 shadow-editorial">
            ...
            <div>
              <h3 className="font-serif text-xl font-bold text-slate-900">No Publications Found</h3>
